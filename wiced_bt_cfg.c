...
uint8_t BT_LOCAL_NAME[] = { 'Z','e','n','i','t','r','o','n',' ','B','T',' ','A','M','P','\0' };
...
const wiced_bt_cfg_settings_t wiced_bt_cfg_settings =
{
    ...
    /* BLE Scan Settings */
    .ble_scan_cfg = {
        .scan_mode =                        BTM_BLE_SCAN_MODE_ACTIVE,                                               /**< BLE Scan Mode (BTM_BLE_SCAN_MODE_PASSIVE or BTM_BLE_SCAN_MODE_ACTIVE) */
        ...
        .high_duty_conn_scan_interval =     96,                                                                     /**< High Duty Connection Cycle Connection Scan Interval */
        .high_duty_conn_scan_window =       48,                                                                     /**< High Duty Connection Cycle Connection Scan Window */
        .high_duty_conn_duration =          30,                                                                     /**< High Duty Connection Cycle Connection Duration in seconds (0 for infinite) */

        .low_duty_conn_scan_interval =      2048,                                                                   /**< Low Duty Connection Cycle Connection Scan Interval */
        .low_duty_conn_scan_window =        48,                                                                     /**< Low Duty Connection Cycle Connection Scan Window */
    ...
    .gatt_cfg = {
        ...
        .server_max_links =                 3,                                                                      /**< Server Config: Maximum number of remote client connections allowed by local server */
        .max_attr_len =                     360,                                                                    /**< Maximum attribute length; wiced_bt_cfg must have a corresponding buffer pool that can hold this length */
#ifndef CYW20706A2
    ...
    .avdt_cfg = {
        .max_links =                        1,                                                                      /**< Maximum Number of simultaneous Audio/Video links */
#ifndef CYW20706A2
    ...
    /* AVRC Configuration */
    .avrc_cfg = {
        .roles =                            1,                                                                      /**< Local Roles supported (AVRC_CONN_INITIATOR or AVRC_CONN_ACCEPTOR) */
        .max_links =                        1,                                                                      /**< Maximum simultaneous Remote Control links */
    },

    /* LE Address Resolution Database Settings */
    .addr_resolution_db_size =              5,                                                                      /**< LE Address Resolution Database Size - Effective only for pre-4.2 controller */
#ifdef CYW20706A2
    .max_mtu_size =                         365,                                                                    /**< Maximum MTU size for GATT connections, should be between 23 and (max_attr_len + 5) */
...
/*  { buf_size, buf_count, }, */
    ...
    { 1056,     4,         }, /* Extra Large Buffer Pool (used for AVDT media packets, GATT DB, and miscellaneous; if not needed, set buf_count to 0) */
};
